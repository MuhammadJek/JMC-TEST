...
@section('content')
                    ...
                    <div class="d-flex align-items-center">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text"
                                ...
                                is-invalid
                            @enderror"
                                id="asal_barang" name="asal_barang" value="{{ old('asal_barang') }}" placeholder="">
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text"
                                ...
                                is-invalid
                            @enderror"
                                id="no_surat" name="no_surat" value="{{ old('no_surat') }}" placeholder="">
                        </div>
                        <div class="form-group col-lg-3">
    ...
    @push('scripts')
        <script>
            ...
            const categoryGroup = @json($categoryFind);
            ...
            categorySelect.addEventListener('change', () => {
                ...
                semesterOption.forEach(semesterr => {
                    ...
                    option.setAttribute('data-price', semesterr.max_price.toLocaleString('id-ID') ?? '');
